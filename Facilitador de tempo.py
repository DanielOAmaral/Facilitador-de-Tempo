...
class Application(Funcs):
    def __init__(self):
        ...
        root.mainloop()
    def tela(self):
        self.root.title("Facilitador de Tempo FDT")
    ...
    def frames_da_tela(self):
        self.frame_1 = Frame(self.root, bd = 4, bg= '#d1d1e0',
                             highlightbackground= '#000000', highlightthickness=4 )
        self.frame_1.place(relx= 0.02, rely=0.02, relwidth= 0.96, relheight= 0.46)

        self.frame_2 = Frame(self.root, bd=4, bg='#9595b7',
                             highlightbackground='#000000', highlightthickness=3)
        self.frame_2.place(relx=0.02, rely=0.5, relwidth=0.96, relheight=0.46)
    def widgets_frame1(self):
        ### Criação do botao novo
        self.bt_limpar = Button(self.frame_1, text="Novo", bd=2, bg='#00cc44', fg='white'
        ...
        self.bt_limpar = Button(self.frame_1, text= "Limpar", bd=2, bg = '#00cc44',fg = 'white'
        ...
        self.bt_limpar = Button(self.frame_1, text="Buscar", bd=2, bg = '#00cc44',fg = 'white'
        ...
        self.lb_nome = Label(self.frame_1, text="Nome Completo", bg= '#dfe3ee', fg = '#107db2')
        ...
        self.lb_nome = Label(self.frame_1, text="Telefone/Celular", bg= '#dfe3ee', fg = '#107db2')
